...
const LIGHTNING_THRASHES_CONFIG: PlaylistConfig = {
  cacheKey: 'lightning_thrashes_playlist_cache_v2',
...
export default function LightningThrashesPlaylistPage() {
  return <PlaylistTemplateCompact config={LIGHTNING_THRASHES_CONFIG} />;
}