...
if [[ "$PROJECT_ID" == "StableKraft - Main Music Project" ]]; then
    echo "✅ Correct project: StableKraft"
    echo "📍 Location: $(pwd)"
    ...
    echo "📍 Location: $(pwd)"
    echo "💡 To switch to StableKraft: cd /Users/chad-mini/Vibe/apps/StableKraft"
    exit 1
else
    echo "❌ Unknown project directory"
    echo "📍 Location: $(pwd)"
    echo "💡 Available projects:"
    echo "   - StableKraft: /Users/chad-mini/Vibe/apps/StableKraft"
