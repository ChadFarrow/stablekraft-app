/**
 * List feeds that failed to sync (not found in Podcast Index)
 */
...
async function categorizeFeeds() {
  console.log('🔍 Categorizing all 106 missing GUIDs...\n');
  ...
  console.log(`❌ Not in database (not found in Podcast Index): ${notInDB.length}\n`);

  console.log('Feeds NOT found in Podcast Index:');
